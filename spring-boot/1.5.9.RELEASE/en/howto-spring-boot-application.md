...
You can use the  `ApplicationBuilder`  class to create parent/child  `ApplicationContext`  hierarchies. See “[Section 23.4, “Fluent Builder API”](boot-features-spring-application.html#boot-features-fluent-builder-api)” in the ‘Spring Boot features’ section for more information.
